	...
	statements := []struct {
		...
		},
		{
			sql: `INSERT INTO projects (
				...
				source_resource_identifier, source_type, source_service_name, source_instance_identifier,
				source_display_name, source_environment, source_status, source_runtime_type,
				source_provider_server_id, monitoring_enabled,
				...
				'app-1', 'application', '', 'instance-1', 'Service', 'prod', 'running', '', '', false,
				300000000000, 10, 10, ?, ?)`,
