...
type IncidentDTO struct {
	...
	GitHubIssueReference *GitHubIssueReferenceDTO           `json:"github_issue_reference,omitempty"`
	LatestInvestigation  *investigationdto.InvestigationDTO `json:"latest_investigation,omitempty"`
}
