...
func TestStartAdministratorSetupHappyPath(t *testing.T) {
	...
	handler := handlerauth.NewHandler(&fakeGetSetupStatusUseCase{}, startSetup, &fakeVerifyAdministratorSetupUseCase{}, &fakeLoginAdministratorUseCase{}, &fakeGetCurrentSessionUseCase{}, &fakeLogoutAdministratorUseCase{}, true)
