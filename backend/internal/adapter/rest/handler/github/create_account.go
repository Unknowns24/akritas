...
func (h *Handler) CreateAccount(w http.ResponseWriter, r *http.Request) {
	var body dto.CreateGitHubPATAccountRequestDTO
	...
	response.JSON(w, http.StatusCreated, dto.DataResponseDTO[dto.GitHubAccountDTO]{Data: mapper.GitHubAccountToDTO(*account)})
}
