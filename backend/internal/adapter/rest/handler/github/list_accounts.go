...
func (h *Handler) ListAccounts(w http.ResponseWriter, r *http.Request) {
	params, err := restpagination.Parse(r, h.paging, restpagination.Policy{
		AllowedFilters: map[string]struct{}{"authentication_status_in": {}},
	...
	if _, valid := integrationStatuses(params.Filters["authentication_status_in"]); !valid {
		response.Invalid(w, r)
		return
	}
	page, err := h.accounts.List(r.Context(), params)
	if err != nil {
