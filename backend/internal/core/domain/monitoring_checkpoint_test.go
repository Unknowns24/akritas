...
func TestMonitoringCheckpointInitialIngestionSemantics(t *testing.T) {
	...
	project := Project{ID: uuid.New(), DokployApplication: DokployApplication{ApplicationIdentifier: "app", InstanceIdentifier: "instance"}, MonitoringConfiguration: DefaultMonitoringConfiguration()}
