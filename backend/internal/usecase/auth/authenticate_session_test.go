...
func TestAuthenticateSessionHappyPath(t *testing.T) {
	...
	uc := NewAuthenticateSessionUseCase(sessions, sessionTokens, clock, authSessionIdleTTL)
...
func TestAuthenticateSessionExpiredOrRevoked(t *testing.T) {
	...
	t.Run("expired", func(t *testing.T) {
		...
		sessions := &fakeAdministratorSessionRepository{findByTokenHashResult: session}
		uc := NewAuthenticateSessionUseCase(sessions, &fakeSessionTokenGenerator{}, &fakeClock{now: now}, authSessionIdleTTL)
