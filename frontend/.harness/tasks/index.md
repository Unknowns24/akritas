...
| --- | --- | --- | --- |
| FE-H5-01-REMEDIATION-LIFECYCLE | complete | frontend-feature | Remediation lifecycle UI para resolution_status=fixable y estados OpenAPI |
...
| FE-H5-06-VISUAL-GATE-H5 | complete | frontend-feature | Gate visual H5 demostrando Issue → fixable → branch → regression test → fix → tests pass → PR con contexto de revisión humana |
